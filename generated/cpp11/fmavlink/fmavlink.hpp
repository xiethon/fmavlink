/** @file
 *	@brief MAVLink comm protocol generated from fmavlink.xml
...
/** @brief 电池状态标志位 */
enum class FM_BATTERY_FLAGS : uint8_t
{
    FLAG_LOW=1, /* 电量偏低 | */
    FLAG_FAULT=2, /* 电池存在故障 | */
};

//! FM_BATTERY_FLAGS ENUM_END
constexpr auto FM_BATTERY_FLAGS_ENUM_END = 3;
...
// MESSAGE DEFINITIONS
#include "./mavlink_msg_fm_battery_status.hpp"
